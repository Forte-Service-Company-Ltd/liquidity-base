...
contract MathLibTests is TestCommon {
    ...
    function testEquations_MathLibTests_QuadraticEquation(uint256 a, uint256 b, uint256 c, bool isBNegative) public {
        ...
        assertEq(scriptValue/1e18, solVal/1e18);
    }
    ...
    function testEquations_MathLibTests_QuadraticEquationMaxUnit() public {
        uint a = 50000000000000000000001999999999999999998000000000000000000000000000000000000;
        uint b = 50000000000000000000001999999799999999997999999999980000000000000000000000000;
        uint c = 50000000000000000000002000000199999999999999999999979999999000000000000000000;
