...
contract PythonUtils is Test {
    ...
    function _buildFFICalculateS(uint Xn, uint C) internal pure returns (string[] memory) {
        string[] memory inputs = new string[](4);
        inputs[0] = "python3";
        inputs[1] = "script/python/ALTBC/calculate_s.py";
        inputs[2] = Xn.toString();
        inputs[3] = C.toString();
        return inputs;
    }

    function _buildFFICalculateCConstant(uint XUpper, uint PUpper, uint PLower) internal pure returns (string[] memory) {
        string[] memory inputs = new string[](5);
        inputs[0] = "python3";
        inputs[1] = "script/python/ALTBC/calculate_C_constant.py";
        inputs[2] = XUpper.toString();
        inputs[3] = PUpper.toString();
        inputs[4] = PLower.toString();
        return inputs;
    }

    function _buildFFICalculateInitialB(uint XUpper, uint PUpper, uint PLower) internal pure returns (string[] memory) {
        string[] memory inputs = new string[](5);
        inputs[0] = "python3";
        inputs[1] = "script/python/ALTBC/calculate_initial_b.py";
        inputs[2] = XUpper.toString();
        inputs[3] = PUpper.toString();
        inputs[4] = PLower.toString();
        return inputs;
    ...
    function _buildFFICalculatefx(uint XUpper, uint PUpper, uint PLower, uint Xn, uint cn) internal pure returns (string[] memory) {
        ...
        inputs[3] = PUpper.toString();
        inputs[4] = PLower.toString();
        inputs[5] = Xn.toString();
        inputs[6] = cn.toString();
        return inputs;
    }
    ...
    function _buildFFICalculateFxInverse(uint cn, uint Bn, uint D) internal pure returns (string[] memory) {
        ...
        inputs[2] = cn.toString();
        inputs[3] = Bn.toString();
        inputs[4] = D.toString();
        return inputs;
    }

    function _buildFFICalculateC(uint DnLow, uint DnHi, uint Sn, uint Xn) internal pure returns (string[] memory) {
        string[] memory inputs = new string[](6);
        inputs[0] = "python3";
        inputs[1] = "script/python/ALTBC/calculate_c.py";
        inputs[2] = DnLow.toString();
        inputs[3] = DnHi.toString();
        inputs[4] = Sn.toString();
        inputs[5] = Xn.toString();
        return inputs;
    }

    function _buildFFICalculateFofX(uint Xn, uint Sn, uint Cn) internal pure returns (string[] memory) {
        string[] memory inputs = new string[](5);
        inputs[0] = "python3";
        inputs[1] = "./script/python/ALTBC/calculate_capital_F_x.py";
        inputs[2] = Xn.toString();
        inputs[3] = Sn.toString();
        inputs[4] = Cn.toString();
        return inputs;
    }
    ...
    function _buildFFICalculateCInitial(uint C, uint xMin, uint pLower) internal pure returns (string[] memory) {
        string[] memory inputs = new string[](5);
        inputs[0] = "python3";
        inputs[1] = "script/python/calculate_c_initial.py";
        inputs[2] = C.toString();
        inputs[3] = xMin.toString();
        inputs[4] = pLower.toString();
        return inputs;
    }
    ...
    function _buildFFICalculateRMax(uint Xn, uint Bn, uint Cn, uint C, uint xMin, uint Dv, uint R) internal pure returns (string[] memory) {
        ...
        inputs[4] = Cn.toString();
        inputs[5] = C.toString();
        inputs[6] = xMin.toString();
        inputs[7] = Dv.toString();
        inputs[8] = R.toString();
        return inputs;
    }
    ...
    function _buildFFICalculateDv(uint Xmin, uint Xupper, uint Plower, uint Pupper) internal pure returns (string[] memory) {
        string[] memory inputs = new string[](6);
        inputs[0] = "python3";
        inputs[1] = "./script/python/calculate_Dv.py";
        inputs[2] = Xmin.toString();
        inputs[3] = Xupper.toString();
        inputs[4] = Plower.toString();
        inputs[5] = Pupper.toString();
        return inputs;
    }
    ...
    function _buildFFICalculatepriceFunctionfx(uint Ln, uint cn, uint Xn) internal pure returns (string[] memory) {
        string[] memory inputs = new string[](5);
        inputs[0] = "python3";
        inputs[1] = "script/python/URQTBC/calculate_f_x.py";
        inputs[2] = Ln.toString();
        inputs[3] = cn.toString();
        inputs[4] = Xn.toString();
        return inputs;
    }

    function _buildFFICalculateURQTBCcn(uint Dn, uint C, uint Xn, uint Vn) internal pure returns (string[] memory) {
        string[] memory inputs = new string[](6);
        inputs[0] = "python3";
        inputs[1] = "script/python/URQTBC/calculate_c_n.py";
        inputs[2] = Dn.toString();
        inputs[3] = C.toString();
        inputs[4] = Xn.toString();
        inputs[5] = Vn.toString();
        return inputs;
    }

    function _buildFFICalculateURQTBCcn(uint Dn, uint C, uint Xn, uint Vn, uint wadLevel) internal pure returns (string[] memory) {
        string[] memory inputs = new string[](7);
        inputs[0] = "python3";
        inputs[1] = "script/python/URQTBC/calculate_c_n.py";
        inputs[2] = Dn.toString();
        ...
        inputs[4] = Xn.toString();
        inputs[5] = Vn.toString();
        inputs[6] = wadLevel.toString();
        return inputs;
    }

    function _buildFFICalculateURQTBCFx(uint Xn, uint Ln, uint Cn) internal pure returns (string[] memory) {
        string[] memory inputs = new string[](5);
        inputs[0] = "python3";
        inputs[1] = "script/python/URQTBC/calculate_capital_F_x.py";
        inputs[2] = Xn.toString();
        inputs[3] = Ln.toString();
        inputs[4] = Cn.toString();
        return inputs;
    }

    function _buildFFICalculateURQTBCFinversed(uint Ln, uint cn, uint Dn) internal pure returns (string[] memory) {
        string[] memory inputs = new string[](5);
        inputs[0] = "python3";
        inputs[1] = "script/python/URQTBC/calculate_F_x_inverse.py";
        inputs[2] = Ln.toString();
        inputs[3] = cn.toString();
        inputs[4] = Dn.toString();
        return inputs;
    }

    function _buildFFICalculateURQTBCZn(uint An, uint Zn, uint lam) internal pure returns (string[] memory) {
        string[] memory inputs = new string[](5);
        inputs[0] = "python3";
        inputs[1] = "script/python/URQTBC/calculate_z_n.py";
        inputs[2] = An.toString();
        inputs[3] = Zn.toString();
        inputs[4] = lam.toString();
        return inputs;
    }

    function _buildFFICalculateURQTBCSigmaSq(uint sigmaSq, uint gamma, uint oldP, uint newP) internal pure returns (string[] memory) {
        string[] memory inputs = new string[](6);
        inputs[0] = "python3";
        inputs[1] = "script/python/URQTBC/calculate_sigmaSq.py";
        inputs[2] = sigmaSq.toString();
        inputs[3] = gamma.toString();
        inputs[4] = oldP.toString();
        inputs[5] = newP.toString();
        return inputs;
    }

    function _buildFFICalculateLInitial(uint Xupper, uint Plower) internal pure returns (string[] memory) {
        string[] memory inputs = new string[](4);
        inputs[0] = "python3";
        inputs[1] = "script/python/URQTBC/calculate_l_initial.py";
        inputs[2] = Xupper.toString();
        inputs[3] = Plower.toString();
        return inputs;
    }

    function _buildFFICalculateLofN(uint Dn, uint Xn, uint C, uint cn, uint V, uint wads) internal pure returns (string[] memory) {
        string[] memory inputs = new string[](8);
        inputs[0] = "python3";
        inputs[1] = "script/python/URQTBC/calculate_l_n.py";
        inputs[2] = Dn.toString();
        inputs[3] = Xn.toString();
        inputs[4] = C.toString();
        inputs[5] = cn.toString();
        inputs[6] = V.toString();
        inputs[7] = wads.toString();
        return inputs;
    }

    function _buildFFIURQTBCCConstant(uint Vi, uint XUpper, uint PLower) internal pure returns (string[] memory) {
        string[] memory inputs = new string[](5);
        inputs[0] = "python3";
        inputs[1] = "script/python/URQTBC/calculate_c_constant.py";
        inputs[2] = Vi.toString();
        inputs[3] = XUpper.toString();
        inputs[4] = PLower.toString();
        return inputs;
    }

    function _buildFFICalculateURQTBCSingularity(uint c, uint l) internal pure returns (string[] memory) {
        string[] memory inputs = new string[](4);
        inputs[0] = "python3";
        inputs[1] = "script/python/URQTBC/calculate_singularity.py";
        inputs[2] = c.toString();
        inputs[3] = l.toString();
        return inputs;
    }
