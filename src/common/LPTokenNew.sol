 ...
 */
contract LPTokenNew is Ownable2Step, ERC721, ERC721Enumerable, ILPToken {
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        return Descriptor.constructTokenURI(tokenId, idToPool[tokenId]); // this line will be replaced by the SVG branch
    }
}
