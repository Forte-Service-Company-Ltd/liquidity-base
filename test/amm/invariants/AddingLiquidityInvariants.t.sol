...
abstract contract AddingLiquidityInvariants is TestCommonSetup {
    ...
    function setUp() public endWithStopPrank {
        ...
        selectors[0] = 0xf9c8b956; // TODO fix once IPool can be modified to PoolBase(address(pool)).depositLiquidity.selector
    ...
    function invariant_liquidityCanNeverDecreaseCallingAddLiquidity_TokenY() public startAsAdmin {
