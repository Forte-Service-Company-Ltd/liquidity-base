...
abstract contract CalculatorBase is Constants {
     ...
     */
    function _calculateAmountOfXReceivedSellingY(packedFloat _amountOfY) internal virtual returns (packedFloat amountOfX);

    function _calculateAmountOfXReceivedSellingYNoLog(packedFloat _amountOfY) internal virtual returns (packedFloat amountOfX);
